(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))d(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&d(r)}).observe(document,{childList:!0,subtree:!0});function l(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function d(s){if(s.ep)return;s.ep=!0;const a=l(s);fetch(s.href,a)}})();const v=10935,Q=5,w=[{name:"Sunlight",sci:"Epipelagic",from:0,to:200,light:"Full sunlight"},{name:"Twilight",sci:"Mesopelagic",from:200,to:1e3,light:"Dim blue light"},{name:"Midnight",sci:"Bathypelagic",from:1e3,to:4e3,light:"Bioluminescence only"},{name:"Abyssal",sci:"Abyssopelagic",from:4e3,to:6e3,light:"Total darkness"},{name:"Hadal",sci:"Hadalpelagic",from:6e3,to:11e3,light:"Total darkness"}];function C(e){return w.find(t=>e<t.to)??w[w.length-1]}const p=[[0,56,172,216],[80,24,126,184],[200,10,82,142],[450,9,50,104],[700,9,33,76],[1e3,7,18,50],[1600,5,11,34],[2500,4,7,24],[4e3,2,4,14],[6e3,1,2,8],[8500,0,1,4],[11e3,0,0,1]];function B(e){const t=Math.max(0,Math.min(v,e));let l=1;for(;l<p.length-1&&p[l][0]<t;)l++;const[d,s,a,r]=p[l-1],[z,I,$,F]=p[l],P=z===d?0:(t-d)/(z-d),y=(S,H)=>Math.round(S+(H-S)*P);return`rgb(${y(s,I)}, ${y(a,$)}, ${y(r,F)})`}const D=Math.log(100)/200;function T(e){return Math.exp(-D*Math.max(0,e))}function j(e){const t=T(e)*100;return e>=1e3?"0%":t>=1?`${Math.round(t)}%`:t>=.01?`${t.toFixed(2)}%`:t>=1e-4?`${t.toFixed(4)}%`:"<0.0001%"}function O(e){return Math.round(1+e/10)}const N=[{id:"flying-fish",name:"Flying Fish",sci:"Exocoetidae",depth:6,range:"Surface",size:120,side:"right",fact:"To escape tuna and marlin, it rockets out of the water and glides on outstretched fins — some stay airborne for over 200 metres before splashing back down.",svg:`
      ...
      </svg>`}],c=document.getElementById("ocean"),g=document.documentElement,n={depth:document.getElementById("hud-depth"),zone:document.getElementById("hud-zone"),zoneSci:document.getElementById("hud-zone-sci"),light:document.getElementById("hud-light"),pressure:document.getElementById("hud-pressure")},x=v*Q;c.style.height=`calc(${x}px + 100svh)`;function M(e){return`calc(${Math.round(e*Q)}px + 50svh)`}const h=document.createElement("div");h.id="ruler";h.setAttribute("aria-hidden","true");h.style.top="50svh";h.style.height=`${x}px`;c.appendChild(h);for(let e=500;e<=v;e+=500){const t=document.createElement("span");t.className="ruler-label",t.textContent=`${e.toLocaleString("en-US")} m`,t.style.top=M(e),c.appendChild(t)}for(const e of w.slice(1)){const t=document.createElement("div");t.className="zone-marker",t.style.top=M(e.from),t.innerHTML=`
    <div class="zone-marker-text">
      ${e.name} Zone · ${e.from.toLocaleString("en-US")} m
      <small>${e.sci}</small>
    </div>`,c.appendChild(t)}const q=new IntersectionObserver(e=>{for(const t of e)t.isIntersecting&&(t.target.classList.add("in-view"),q.unobserve(t.target))},{rootMargin:"0px 0px -12% 0px"});for(const e of N){const t=document.createElement("article");t.className=e.depth>=1e3?"creature deep":"creature",t.dataset.side=e.side,t.dataset.id=e.id,t.style.top=M(e.depth),t.innerHTML=`
    ...
    </div>`,t.querySelector(".creature-tap").addEventListener("click",()=>W(e)),c.appendChild(t),q.observe(t)}const i=document.createElement("div");i.id="detail";i.hidden=!0;i.innerHTML=`
  ...
  </div>`;document.body.appendChild(i);const o={sprite:i.querySelector(".detail-sprite"),zone:i.querySelector("#detail-zone"),zonefull:i.querySelector("#detail-zonefull"),name:i.querySelector("#detail-name"),sci:i.querySelector("#detail-sci"),range:i.querySelector("#detail-range"),fact:i.querySelector("#detail-fact"),card:i.querySelector(".detail-card")};let k=null;function W(e){const t=C(e.depth);o.sprite.innerHTML=e.svg,o.sprite.style.maxWidth=`${Math.min(e.size*1.7,260)}px`,o.zone.textContent=`${t.name} Zone`,o.zonefull.textContent=`${t.name} · ${t.sci}`,o.name.textContent=e.name,o.sci.textContent=e.sci,o.range.textContent=e.range,o.fact.textContent=e.fact,i.dataset.zone=t.name.toLowerCase(),k=document.activeElement,i.hidden=!1,document.body.style.overflow="hidden",requestAnimationFrame(()=>i.classList.add("open")),i.querySelector(".detail-close").focus()}function L(){i.classList.remove("open"),document.body.style.overflow="";const e=()=>{i.hidden=!0,i.removeEventListener("transitionend",e)};i.addEventListener("transitionend",e),k&&k.focus()}i.addEventListener("click",e=>{e.target.hasAttribute("data-close")&&L()});document.addEventListener("keydown",e=>{e.key==="Escape"&&!i.hidden&&L()});let f=null;o.card.addEventListener("touchstart",e=>{f=e.touches[0].clientY},{passive:!0});o.card.addEventListener("touchmove",e=>{if(f===null)return;const t=e.touches[0].clientY-f;t>0&&(o.card.style.transform=`translateY(${Math.min(t,200)}px)`)},{passive:!0});o.card.addEventListener("touchend",e=>{const t=e.changedTouches[0].clientY-(f??0);o.card.style.transform="",t>90&&L(),f=null},{passive:!0});const Z=document.createElement("div");Z.id="floor";Z.innerHTML=`
  <div class="floor-line">Challenger Deep · bottom of the Mariana Trench</div>
  <span class="floor-depth">10,935 m</span>`;c.appendChild(Z);const m=document.getElementById("zone-toast"),R=m.querySelector(".zt-title"),Y=m.querySelector(".zt-sub");let A=null;function J(e){R.textContent=`The ${e.name} Zone`,Y.textContent=`${e.sci} · ${e.light}`,m.classList.add("show"),clearTimeout(A),A=setTimeout(()=>m.classList.remove("show"),2400)}const V=[{el:document.querySelector(".biolum-a"),speed:.05,tile:360},{el:document.querySelector(".biolum-b"),speed:.11,tile:440},{el:document.querySelector(".biolum-c"),speed:.19,tile:600}];let b=!1,u=null,E=-1;function G(){b=!1;const e=Math.max(0,Math.min(window.scrollY,x)),t=e/Q,l=window.innerHeight/Q;g.style.setProperty("--sea-hi",B(t-l/2)),g.style.setProperty("--sea-lo",B(t+l/2)),g.style.setProperty("--sunlight",T(t).toFixed(4));const d=Math.max(0,Math.min(1,(t-900)/400));if(g.style.setProperty("--biolum",d.toFixed(3)),d>0)for(const r of V)r.el.style.transform=`translate3d(0, ${-(e*r.speed%r.tile)}px, 0)`;const s=Math.round(t);s!==E&&(E=s,n.depth.textContent=s.toLocaleString("en-US"),n.light.textContent=j(t),n.pressure.textContent=O(t).toLocaleString("en-US"));const a=C(t);if(a!==u){const r=u===null;u=a,n.zone.textContent=a.name,n.zoneSci.textContent=a.sci,r||J(a)}}window.addEventListener("scroll",()=>{b||(b=!0,requestAnimationFrame(G))},{passive:!0});window.addEventListener("resize",G,{passive:!0});G();"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./sw.js")});
